...
const testimonials = [
    ...
    {
        name: 'Emily Davis',
        text: 'Had a flat tire during my morning ride, and GearGrow Cycle came to the rescue quickly! Professional, friendly, and got me back on the road in no time. Lifesavers!',
            ...
            <section className='py-16 bg-[#060608]'>
                <div className='container mx-auto px-4 text-center'>
                    ...
                    <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                        Hear directly from our satisfied customers about their
                        experience with Doorstep Bicycle Maintenance.
                    </p>
                </div>
            </section>
            ...
            <section className='py-16 bg-[#060608]'>
                <div className='container mx-auto px-4 text-center'>
                    ...
                    <p className='text-gray-300 text-lg max-w-2xl mx-auto mb-8'>
                        Join hundreds of satisfied customers who trust us with
                        their bicycle maintenance.
                    </p>
                    <Link href='/services'>
