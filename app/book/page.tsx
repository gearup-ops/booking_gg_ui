...
// import { CheckCircle2, Upload, MapPin, X } from 'lucide-react';
...
//                 }
//                 // if (!cycle.image) {
//                 //     errors[`cycle-${index}-photo`] = 'Cycle photo is required';
//                 // }
//             });
...
//                 formData.append('address1', customerDetails.addressLine1);
//                 formData.append('address2', customerDetails.addressLine2 || '');
//                 formData.append('city', customerDetails.city);
//                 formData.append('pincode', customerDetails.pinCode);
...
//                             }
//                         >
//                             <SelectTrigger className='bg-white border-[#4a4b4d] text-black placeholder:text-gray-600 w-full'>
//                                 <SelectValue placeholder='Select city' />
//                             </SelectTrigger>
//                             <SelectContent>
//                                 <SelectItem value='2'>Pune</SelectItem>
//                                 <SelectItem value='1'>Mumbai</SelectItem>
//                                 <SelectItem value='3'>Bengaluru</SelectItem>
//                             </SelectContent>
//                         </Select>
//                     </div>
//                     <div className='space-y-2'>
...
//             dispatch(setCurrentStep('cycle-details'));
//         } else if (currentStep === 'cycle-details') {
//             console.log('Submitting order with cycles:', cycles);
...
//                 console.log(
//                     'Location not available for pin code:',
//                     customerDetails.pinCode
//                 );

//                 // Allow submission even if location not available for future contact
//                 setValidationErrors({});
//             }

//             if (selectedService) {
//                 console.log('Creating FormData for order submission');
