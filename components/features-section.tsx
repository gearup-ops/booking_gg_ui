...
export default function FeaturesSection() {
    const features = [
        ...
        },
        {
            ...
            description:
                'Our experts come to your location for convenient service',
        },
        {
            icon: Star,
            title: 'Enjoy riding',
            description:
                'Get back to riding with a perfectly maintained bicycle',
        },
    ];

    return (
        <section className='pt-16 md:py-16 bg-[#3c3d3f]'>
